...
type StatemachineServiceClient interface {
	...
	GetFiniteStateMachine(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*FiniteStateMachine, error)
	// Looks up all the FSMs, with the given `config_name` that are in the given `state`
	// and returns their IDs.
	GetAllInState(ctx context.Context, in *GetAllFsmRequest, opts ...grpc.CallOption) (*ListResponse, error)
	...
	StreamAllInstate(ctx context.Context, in *GetAllFsmRequest, opts ...grpc.CallOption) (StatemachineService_StreamAllInstateClient, error)
	// Process an Event for an FSM, identified by `dest`.
	//
	// If events are processed asynchronously, the `outcome` will be empty, but
	...
	GetEventOutcome(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*EventResponse, error)
}
...
func (c *statemachineServiceClient) GetFiniteStateMachine(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*FiniteStateMachine, error) {
...
func (c *statemachineServiceClient) GetAllInState(ctx context.Context, in *GetAllFsmRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	out := new(ListResponse)
...
func (c *statemachineServiceClient) StreamAllInstate(ctx context.Context, in *GetAllFsmRequest, opts ...grpc.CallOption) (StatemachineService_StreamAllInstateClient, error) {
...
func (c *statemachineServiceClient) ProcessEvent(ctx context.Context, in *EventRequest, opts ...grpc.CallOption) (*EventResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/statemachine.v1beta.StatemachineService/ProcessEvent", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statemachineServiceClient) GetEventOutcome(ctx context.Context, in *wrapperspb.StringValue, opts ...grpc.CallOption) (*EventResponse, error) {
	out := new(EventResponse)
...
type StatemachineServiceServer interface {
	...
	// Retrieves an FSM by its ID.
	GetFiniteStateMachine(context.Context, *wrapperspb.StringValue) (*FiniteStateMachine, error)
	// Looks up all the FSMs, with the given `config_name` that are in the given `state`
	// and returns their IDs.
	GetAllInState(context.Context, *GetAllFsmRequest) (*ListResponse, error)
	// Streams the full contents of the `FiniteStateMachine` that match the request,
	// including their `id`.
	//
	// For this method call, the `state` may optionally be empty, all the FSMs that match
	...
	// The server may optionally choose not to implement this feature, and return an
	// `InvalidRequest` if `state` is empty.
	StreamAllInstate(*GetAllFsmRequest, StatemachineService_StreamAllInstateServer) error
	// Process an Event for an FSM, identified by `dest`.
	//
	// If events are processed asynchronously, the `outcome` will be empty, but
	// the returned `event_id` can be used later on to query the outcome of the
	...
	// Get the outcome of an event processing, identified by the `event_id` returned by `ProcessEvent`.
	GetEventOutcome(context.Context, *wrapperspb.StringValue) (*EventResponse, error)
...
func (UnimplementedStatemachineServiceServer) GetFiniteStateMachine(context.Context, *wrapperspb.StringValue) (*FiniteStateMachine, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFiniteStateMachine not implemented")
}
func (UnimplementedStatemachineServiceServer) GetAllInState(context.Context, *GetAllFsmRequest) (*ListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllInState not implemented")
}
func (UnimplementedStatemachineServiceServer) StreamAllInstate(*GetAllFsmRequest, StatemachineService_StreamAllInstateServer) error {
...
func (UnimplementedStatemachineServiceServer) GetEventOutcome(context.Context, *wrapperspb.StringValue) (*EventResponse, error) {
...
func _StatemachineService_GetFiniteStateMachine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatemachineServiceServer).GetFiniteStateMachine(ctx, req.(*wrapperspb.StringValue))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _StatemachineService_GetAllInState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatemachineServiceServer).GetAllInState(ctx, req.(*GetAllFsmRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _StatemachineService_StreamAllInstate_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetAllFsmRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
...
func _StatemachineService_ProcessEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/statemachine.v1beta.StatemachineService/ProcessEvent",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _StatemachineService_GetEventOutcome_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatemachineServiceServer).GetEventOutcome(ctx, req.(*wrapperspb.StringValue))
	}
	return interceptor(ctx, in, info, handler)
}
